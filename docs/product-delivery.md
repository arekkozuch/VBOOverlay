...
| F10 | Partial: lap and per-sector timing consistency (median and interquartile range with sample count, minimum 3, ranking eligibility), day and per run (KAN-62); per-corner braking/apex/exit/pickup and racing-line variability, measured vs inferred kept apart, line spread against GPS accuracy (KAN-63) | Eligible populations, timing/braking/exit/line variability and presentation: [KAN-62]–[KAN-64]; acceptance: [KAN-74] |
