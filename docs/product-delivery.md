...
| F10 | Partial: lap and per-sector timing consistency (median and interquartile range with sample count, minimum 3, ranking eligibility), day and per run (KAN-62) | Eligible populations, timing/braking/exit/line variability and presentation: [KAN-62]–[KAN-64]; acceptance: [KAN-74] |
