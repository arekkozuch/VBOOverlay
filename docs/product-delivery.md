...
| F04 | Partial: per-sector theoretical best across a compatible population, with the donor lap for each sector and the total withheld when any sector is uncovered; no UI yet (KAN-56) | Sector theoretical and donor provenance: [KAN-50], [KAN-51], [KAN-56]–[KAN-58]; separately validated realistic potential: [KAN-94]–[KAN-96] |
