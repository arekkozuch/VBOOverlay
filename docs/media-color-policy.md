...
One private macOS validation fixture (GoPro HERO11, August 2026) was HEVC Main 10 at 5312×2988, `60000/1001`, full-range BT.709. Native 5312×2988 and 3840×2160 exports both passed with HEVC Main 10, `yuv420p10le`, and the same range/matrix/transfer/primaries. This confirms the SDR Main10 path on that renderer/VideoToolbox configuration only; it does not validate HDR/Log or production 8K support.
